...
//Announcement
routes.post("/announcement/add",upload.single("attachment"),announcementController.add)
routes.post("/announcement/getAll",announcementController.getAll)
routes.post("/announcement/getSingle",announcementController.getSingle)
routes.post("/announcement/update",upload.single("attachment"),announcementController.update)
routes.post("/announcement/delete",announcementController.delAnnouncement)
routes.post("/announcement/changeStatus",announcementController.changeStatus)
